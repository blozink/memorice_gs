...
function checkForMatch() {
  const isMatch =
    selectedCards[0].getElementsByClassName("image-top")[0].style
      .backgroundImage ===
    selectedCards[1].getElementsByClassName("image-top")[0].style
      .backgroundImage;
...
function gameSequence() {
  startCountdown(5, "El juego comenzará en", function () {
    ...
    startCountdown(10, "Tiempo para memorizar", function () {
      flipAllCards(false);
      startCountdown(25, "Tiempo para jugar", function () {
        endGame(false);
      });
    });
  });
...
function showEndGamePopup(won) {
  ...
  playAgainButton.onclick = function () {
    ...
    setTimeout(function () {
      // Agrega un pequeño retraso para permitir que el sonido se inicie antes de cambiar de página
